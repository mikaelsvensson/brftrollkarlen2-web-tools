<div id="jsonForm" class="hidden overlay">
    <div class="container-fluid">
        ...
        <ol>
            ...
            <li>Ett formul&auml;r &ouml;ppnas och du kan fylla i parametrarna, ex. LGHNR. Om allt g&aring;r som det ska s&aring; ska v&auml;rdena fr&aring;n nedanst&aring;ende formul&auml;r automatiskt fyllas i.</li>
            <li>Tryck p&aring; "Ok". Parametrarna i dokumentet, ex "$LGHNR", kommer nu ers&auml;ttas med det du skrev in.</li>
        </ol>

        <textarea id="jsonData" style="width: 50em; height: 10em;"></textarea>
